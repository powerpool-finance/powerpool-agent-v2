...
contract RandaoExecuteSelectorTest is TestHelperRandao {
  ...
  function testRdIntervalJobExecutionReverted() public {
    ...
    assertApproxEqAbs(keeperWorker.balance - workerBalanceBefore, 0.003753125 ether, 0.00005 ether);
  }
  ...
  function testRdIntervalJobExecutionRevertedCompensationLessThanBalance() public {
    ...
    assertEq(_jobCredits(jobKey), 0);
    assertEq(keeperWorker.balance, 1 ether);
  }
}
